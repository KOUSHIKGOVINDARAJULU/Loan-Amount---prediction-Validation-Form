...
//  tearm validation
$("#tearm").on("change",()=>{
    var Tearm = document.getElementById("tearm").value.trim();
    if(Tearm == "120" || Tearm== "180"|| Tearm== "360" || Tearm== "480"){
        tearmval = true;
        success_msg("tearm_msg","tearm");
    } 
    else{
        error_msg("tearm_msg","Please select the option","tearm");
    }
})
